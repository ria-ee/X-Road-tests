...
def test_configure_service(case, client=None, client_name=None, client_id=None, service_name=None,
    ...
    # wsdl_malformed_url = 'http://xtee2.asa:8080/www/'  # URL that doesn't return a WSDL
    ...
    # wsdl_correct_url = 'http://xtee2.asa:8080/www/testservice.wsdl'  # Correct URL that returns a WSDL file
    ...
    # wsdl_duplicate_url = 'http://xtee2.asa:8080/www/mock-duplicate.wsdl'  # Contains the same service as wsdl_correct_url
    ...
    # wsdl_error_url = 'http://xtee2.asa:8080/www/error.wsdl'  # WSDL that cannot be validated
    ...
    # wsdl_warning_url = 'http://xtee2.asa:8080/www/warning.wsdl'  # WSDL that gives a validator warning
    ...
    # testservice_name = 'bodyMassIndex.v1'
