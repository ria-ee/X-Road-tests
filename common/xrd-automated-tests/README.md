...
Copy the mock service data (all files except README under _mock/mock_service/_ directory, _gatling_scripts/gatling_mock.xml_, _gatling_scripts/soapui-settings-gatling.xml_) to the same directory
...
# Performance tests
Performance test setup and runing information can be found from X-road automated testing documentation.(in folder: common/xrd-automated-tests)
